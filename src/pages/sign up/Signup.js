    ...
    const headers = {
      ...
      const handleSignUp = async () => {
        try {
          ...
          // First API call
          const formSubmissionResponse = await axios.post(api + 'Account/create', formData, { headers });
          ...
          // Second API call
          const imageUploadResponse = await axios.put(api + 'user/uploadImage', formDataForImages, { headers });
